...
define('WP_HOME', 'https://stayconnected.azurewebsites.net/iteration1');
define('WP_SITEURL', 'https://stayconnected.azurewebsites.net/iteration1');
define('DOMAIN_CURRENT_SITE', $_SERVER['HTTP_HOST']);
/** Absolute path to the WordPress directory. */
define('UPLOADS', 'wp-content/uploads'); 
define('WP_PLUGIN_DIR', __DIR__ . "/wp-content/plugins"); 
define('WP_PLUGIN_URL', 'https://stayconnected.azurewebsites.net/iteration1/wp-content/plugins'); 
