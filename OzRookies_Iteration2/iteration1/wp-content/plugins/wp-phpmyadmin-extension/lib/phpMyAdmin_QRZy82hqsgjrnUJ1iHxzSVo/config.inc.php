...
$i++;
$cfg['Servers'][$i]['host'] 			= 'stayconnected-5897-dbserver.mysql.database.azure.com';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= 'qRMR>$`NlS\\2I-Wq={2]Dr@S5||AFSAF' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_QRZy82hqsgjrnUJ1iHxzSVo/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
