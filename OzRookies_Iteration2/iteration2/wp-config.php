...
define('WP_HOME', 'https://stayconnected.azurewebsites.net/iteration2');
define('WP_SITEURL', 'https://stayconnected.azurewebsites.net/iteration2');
...
define('WP_PLUGIN_URL', 'https://stayconnected.azurewebsites.net/iteration2/wp-content/plugins'); 
