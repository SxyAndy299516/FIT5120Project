...
$possible_plugin_locations = array(
	...
	'/home/site/wwwroot/wp-content/plugins/wp-optimize/cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('https://stayconnected.azurewebsites.net/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/home/site/wwwroot/wp-content/plugins/wp-optimize/cache/extensions');
}
